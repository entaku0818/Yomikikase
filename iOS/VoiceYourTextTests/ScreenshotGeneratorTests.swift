...
final class ScreenshotGeneratorTests: XCTestCase {
    ...
    private func allScreenshots() -> [(String, AnyView)] {
        [
            // JA
            ("ja_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "読む手間を、\n声に任せよう")       { MockScreenWithTopTab(title: "読み上げ")          { HomeContent() } }.environment(\.locale, .init(identifier: "ja")))),
            ("ja_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "PDF・Web・\n電子書籍に対応")        { PDFReadingContent() }.environment(\.locale, .init(identifier: "ja")))),
            ...
            // EN
            ("en_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "Let Your Voice\nDo the Reading")       { MockScreenWithTopTab(title: "Voice Narrator")  { HomeContent() } }.environment(\.locale, .init(identifier: "en")))),
            ("en_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "PDF, Web &\neBooks Supported")         { PDFReadingContent() }.environment(\.locale, .init(identifier: "en")))),
            ...
            // DE
            ("de_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "Lesen leicht\ngemacht")                { MockScreenWithTopTab(title: "Voice Narrator")  { HomeContent() } }.environment(\.locale, .init(identifier: "de")))),
            ("de_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "PDF, Web und\neBooks unterstützt")     { PDFReadingContent() }.environment(\.locale, .init(identifier: "de")))),
            ...
            // ES
            ("es_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "Deja que la voz\nlea por ti")          { MockScreenWithTopTab(title: "Voice Narrator")  { HomeContent() } }.environment(\.locale, .init(identifier: "es")))),
            ("es_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "PDF, web\ny eBooks")                   { PDFReadingContent() }.environment(\.locale, .init(identifier: "es")))),
            ...
            // FR
            ("fr_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "Laissez la voix\nfaire la lecture")    { MockScreenWithTopTab(title: "Voice Narrator")  { HomeContent() } }.environment(\.locale, .init(identifier: "fr")))),
            ("fr_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "PDF, Web et\ne-books pris en charge")  { PDFReadingContent() }.environment(\.locale, .init(identifier: "fr")))),
            ...
            // IT
            ("it_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "Lascia che la voce\nlegga per te")     { MockScreenWithTopTab(title: "Voice Narrator")  { HomeContent() } }.environment(\.locale, .init(identifier: "it")))),
            ("it_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "PDF, Web ed\ne-book supportati")       { PDFReadingContent() }.environment(\.locale, .init(identifier: "it")))),
            ...
            // KO
            ("ko_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "읽는 수고를\n목소리에 맡겨요")           { MockScreenWithTopTab(title: "Voice Narrator")  { HomeContent() } }.environment(\.locale, .init(identifier: "ko")))),
            ("ko_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "PDF・웹・\n전자책 지원")                  { PDFReadingContent() }.environment(\.locale, .init(identifier: "ko")))),
            ...
            // TH
            ("th_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "ปล่อยให้เสียง\nอ่านแทนคุณ")           { MockScreenWithTopTab(title: "Voice Narrator")  { HomeContent() } }.environment(\.locale, .init(identifier: "th")))),
            ("th_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "รองรับ PDF\nเว็บ และ eBook")           { PDFReadingContent() }.environment(\.locale, .init(identifier: "th")))),
            ...
            // TR
            ("tr_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "Okuma zahmetini\nsese bırakın")        { MockScreenWithTopTab(title: "Voice Narrator")  { HomeContent() } }.environment(\.locale, .init(identifier: "tr")))),
            ("tr_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "PDF, Web ve\ne-Kitap desteği")         { PDFReadingContent() }.environment(\.locale, .init(identifier: "tr")))),
            ...
            // VI
            ("vi_01_demo",     AnyView(AppStoreScreenshotWithFrame(caption: "Để giọng nói\nđọc cho bạn")           { MockScreenWithTopTab(title: "Voice Narrator")  { HomeContent() } }.environment(\.locale, .init(identifier: "vi")))),
            ("vi_02_features", AnyView(AppStoreScreenshotWithFrame(caption: "Hỗ trợ PDF\nWeb & eBook")              { PDFReadingContent() }.environment(\.locale, .init(identifier: "vi")))),
